    ...
    <div class="col-full">
        ...
        <center>
            <?php foreach ($transaksi as $transaksi) : ?>
                ...
                <div class="row">
                    <div class="col-6">
                        <form action="<?= base_url('user/transaksisaldo/hapus') . '/' . $transaksi['id'] ?>" method="post" id="hapustransaksi">
                            <?= csrf_field() ?>
                            <input type="hidden" name="_method" value="DELETE">
                            <button type="button" class="btn btn-danger tmbl-hps" style="width: 100%;" data-nama="<?= $transaksi['order_number'] ?>">Hapus</button>
                        </form>
                    </div>
                    <div class="col-6">
