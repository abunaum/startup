            ...
            <div class="box-shape pl-lg-5 pr-lg-5 pt-lg-4 pb-lg-4 p-3">
                ...
                <div class="d-flex">
                    <div class="ml-auto pb-2 mt-4">
                        ...
                        <button class="btn btn btn-success button-green" id="payment_instruction_button" data-toggle="modal" data-target="#cara_bayar">Cara Pembayaran</button>
                    </div>
                </div>
                <div class="d-flex">
                ...
                <div id="payment-modal" class="custom-accordion">
                    <div class="card custom-padding-accordion">
                        <div class="card-header payment-instruction-head" id="payment-instruction-head-0">
                            <h5 class="mb-0">
                                <span class="btn collaped panel-title" data-toggle="collapse" data-target="#payment-instruction-collapse-0" aria-expanded="true" aria-controls="payment-instruction-collapse-0">Pembayaran via <?= $transaksi['instructions'][0]['title'] ?></span>
                            </h5>
                        </div>
